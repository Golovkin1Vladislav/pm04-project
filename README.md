...
1. **Индивидуальное задание** Записаться на курс, изучить теоретические материалы в текстовом и видео форматах, выполнить практические задания, пройти тестирование, получить сертификат, оформить результаты в отчете практики. Курс: github.com — Docker практический опыт
